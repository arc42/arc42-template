...
* Provide the system as a cloud-hosted web application so that all user groups can access it centrally.
...
* Support important workflows such as enrollment, attendance tracking, grading, and notifications in one integrated platform.
