...
.Motivation
Für eine tragfähige Architektur sollten Sie explizit wissen, wo Ihre Freiheitsgrade bezüglich der Entwurfsentscheidungen liegen und wo Sie Randbedingungen beachten müssen.
