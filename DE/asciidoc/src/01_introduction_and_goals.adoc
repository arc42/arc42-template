...
[role="arc42help"]
****
Beschreibt die wesentlichen Anforderungen und
...
* relevanten Stakeholder und deren Erwartungshaltung
****
...
****
.Inhalt
Die Top-3 bis Top-5 der Qualitätsziele für die Architektur, deren Erfüllung
oder Einhaltung den maßgeblichen Stakeholdern besonders wichtig sind.
Gemeint sind hier wirklich Qualitätsziele, die nicht unbedingt mit den Zielen
